...
| Datei | Inhalt |
|---|---|
| `VIU_LoHaTes.xml` | Virtueller UDP-Eingang (Port 7091) mit allen 10 Status-Werten |
...
5. **Anpassen:** Beim Virtuellen Ausgang die Adresse auf die IP deines LoHaTes-ESP
   ändern (`/dev/udp/<esp-ip>/7091`); beim UDP-Eingang optional die Senderadresse setzen
...
output address to your ESP's IP (`/dev/udp/<esp-ip>/7091`).
